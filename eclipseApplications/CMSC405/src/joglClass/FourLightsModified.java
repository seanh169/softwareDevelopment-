 ...
 */
public class FourLightsModified extends JPanel implements GLEventListener {

    public static void main(String[] args) {
        JFrame window = new JFrame("A Lighting Demo - Modified");
        FourLightsModified panel = new FourLightsModified();
    ...
    private void lights(GL2 gl) {
        ...
        gl.glPushMatrix();
        gl.glRotated(-frameNumber, 2, 3, 2);
    ...
    private void drawCylinder(GL2 gl) {
    	...
    	gl.glNormal3f(0,0,1);
    	gl.glTexCoord2d(0,0);     // Texture coords for lower left corner
    	gl.glVertex3d(-0.5,-0.5, -0.5);
    	gl.glTexCoord3d(1,0,1);     // Texture coords for lower right corner
    	gl.glVertex3d(0.5,-0.5, 0.5);
    	gl.glTexCoord3d(1,1, 1);     // Texture coords for upper right corner
    	gl.glVertex2d(0.5,0.5);
    	gl.glTexCoord2d(0,1);     // Texture coords for upper left corner
    	gl.glVertex2d(-0.5,0.5);
    	gl.glEnd();
